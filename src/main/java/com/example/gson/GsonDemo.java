...
public class GsonDemo {
    public static void main(String[] args) {
    	...
    	String employeesStr="{\"id\":1,\"name\":\"汤成锋\",\"username\":\"18965910111\",\"pyshortname\":\"tcf\",\"pysortkey\":\"tang汤cheng成feng锋\",\"pyname\":\"tangchengfeng\",\"t9code\":\"8264,24364,3364\",\"t9shortcode\":\"823\",\"gender\":0,\"email\":\"tcf@strongsoft.net\",\"mobile\":\"18965910111,87649888\",\"address\":null,\"bio\":\"高度决定长度，格局决定大小\",\"lasttm\":\"2016-08-01T17:36:38\",\"avatar\":null,\"state\":null,\"postcode\":\"350100\",\"chinesecode\":\"福建省-福州市\",\"atiem\":\"福建省-福州市\"}";
    	
    	Gson gson2=new GsonBuilder().serializeNulls().create();
    	EmployeesEntriy employeesEntriy= gson2.fromJson(employeesStr, EmployeesEntriy.class);
    	System.out.println("statu="+ employeesEntriy.getName()+" id="+employeesEntriy.getId());
